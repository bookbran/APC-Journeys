...
export const coaches: CoachProfile[] = [
  ...
  {
    name: "Matt Roberts",
    title: "Career Pivot & Change Coach",
    rate: "$170/hr",
  ...
  {
    name: "Brad Fortier",
    title: "Career Pivot & Communication Coach",
    rate: "$170/hr",
  ...
  },
  {
    ...
    title: "Career Pivot & Development Coach",
    rate: "$170/hr",
...
export const situationRoutes: SituationRoute[] = [
  ...
  },
  {
    ...
    journey: "Pivot",
    journeyColor: "#54558e",
    coaches: "Aimee, Victoria, Autumn, Emily, Matt, Brad, Jeanne",
  ...
  },
  {
    ...
    journey: "Advancing",
    journeyColor: "#16163f",
    coaches: "Aimee, Emily, Victoria, Matt, Brad, Jeanne",
...
export const pricingData = [
  ...
  { name: "Aimee, Victoria, Emily, Krute, Autumn, Matt, Brad, Jeanne", rate: "$170/hr", note: "All other coaches" },
